...
namespace BattleshipGame.Tests
{
    ...
    {
        [Fact] public void Can_Add_Horizontal_Ship_To_Board_Within_Board_Bounds() => MakeBoard()
            .TryAdd(new Ship(0, 0, Direction.Horizontal, 10))
            .Should()
            .Be(true);

       [Fact] public void Can_Add_Vertical_Ship_To_Board_Within_Board_Bounds() => MakeBoard()
            .TryAdd(new Ship(0, 0, Direction.Vertical, 10))
            .Should()
            .Be(true);

       [Fact] public void Cannot_Add_Horizontal_Ship_To_Board_OutOf_X_Bounds() => MakeBoard()
            .TryAdd(new Ship(1, 0, Direction.Horizontal, 10))
            .Should()
            .Be(false);

       [Fact] public void Cannot_Add_Vertical_Ship_To_Board_OutOf_X_Bounds() => MakeBoard()
            .TryAdd(new Ship(10, 0, Direction.Vertical, 10))
            .Should()
            .Be(false);

       [Fact] public void Cannot_Add_Horizontal_Ship_To_Board_OutOf_Y_Bounds() => MakeBoard()
       ...
       [Fact]
        ...
        [Fact] public void Can_Add_Ship_Which_DoesNot_Overlap_With_Another_Ship()
        {
